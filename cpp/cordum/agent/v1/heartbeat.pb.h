...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cordum_2fagent_2fv1_2fheartbeat_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_cordum_2fagent_2fv1_2fheartbeat_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_cordum_2fagent_2fv1_2fheartbeat_2eproto
...
struct TableStruct_cordum_2fagent_2fv1_2fheartbeat_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cordum_2fagent_2fv1_2fheartbeat_2eproto;
namespace cordum {
namespace agent {
namespace v1 {
class Heartbeat;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::cordum::agent::v1::Heartbeat* Arena::CreateMaybeMessage<::cordum::agent::v1::Heartbeat>(Arena*);
template<> ::cordum::agent::v1::Heartbeat_LabelsEntry_DoNotUse* Arena::CreateMaybeMessage<::cordum::agent::v1::Heartbeat_LabelsEntry_DoNotUse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace cordum {
namespace agent {
namespace v1 {
...
public:
  ...
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "cordum.agent.v1.Heartbeat.LabelsEntry.key");
 }
  static bool ValidateValue(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "cordum.agent.v1.Heartbeat.LabelsEntry.value");
 }
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadata() const final;
  friend struct ::TableStruct_cordum_2fagent_2fv1_2fheartbeat_2eproto;
};

// -------------------------------------------------------------------

class Heartbeat final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cordum.agent.v1.Heartbeat) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "cordum.agent.v1.Heartbeat";
  }
  protected:
...
inline const std::string& Heartbeat::worker_id() const {
  // @@protoc_insertion_point(field_get:cordum.agent.v1.Heartbeat.worker_id)
...
void Heartbeat::set_worker_id(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.worker_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cordum.agent.v1.Heartbeat.worker_id)
}
inline std::string* Heartbeat::mutable_worker_id() {
  std::string* _s = _internal_mutable_worker_id();
  // @@protoc_insertion_point(field_mutable:cordum.agent.v1.Heartbeat.worker_id)
  return _s;
}
...
inline std::string* Heartbeat::release_worker_id() {
  // @@protoc_insertion_point(field_release:cordum.agent.v1.Heartbeat.worker_id)
...
inline const std::string& Heartbeat::region() const {
  // @@protoc_insertion_point(field_get:cordum.agent.v1.Heartbeat.region)
...
void Heartbeat::set_region(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.region_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cordum.agent.v1.Heartbeat.region)
}
inline std::string* Heartbeat::mutable_region() {
  std::string* _s = _internal_mutable_region();
  // @@protoc_insertion_point(field_mutable:cordum.agent.v1.Heartbeat.region)
  return _s;
}
...
inline std::string* Heartbeat::release_region() {
  // @@protoc_insertion_point(field_release:cordum.agent.v1.Heartbeat.region)
...
inline const std::string& Heartbeat::type() const {
  // @@protoc_insertion_point(field_get:cordum.agent.v1.Heartbeat.type)
...
void Heartbeat::set_type(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.type_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cordum.agent.v1.Heartbeat.type)
}
inline std::string* Heartbeat::mutable_type() {
  std::string* _s = _internal_mutable_type();
  // @@protoc_insertion_point(field_mutable:cordum.agent.v1.Heartbeat.type)
  return _s;
}
...
inline std::string* Heartbeat::release_type() {
  // @@protoc_insertion_point(field_release:cordum.agent.v1.Heartbeat.type)
...
inline float Heartbeat::cpu_load() const {
  // @@protoc_insertion_point(field_get:cordum.agent.v1.Heartbeat.cpu_load)
...
inline float Heartbeat::gpu_utilization() const {
  // @@protoc_insertion_point(field_get:cordum.agent.v1.Heartbeat.gpu_utilization)
...
inline int32_t Heartbeat::active_jobs() const {
  // @@protoc_insertion_point(field_get:cordum.agent.v1.Heartbeat.active_jobs)
...
inline std::string* Heartbeat::add_capabilities() {
  ...
  // @@protoc_insertion_point(field_add_mutable:cordum.agent.v1.Heartbeat.capabilities)
  return _s;
}
...
inline const std::string& Heartbeat::capabilities(int index) const {
  // @@protoc_insertion_point(field_get:cordum.agent.v1.Heartbeat.capabilities)
  return _internal_capabilities(index);
}
inline std::string* Heartbeat::mutable_capabilities(int index) {
  // @@protoc_insertion_point(field_mutable:cordum.agent.v1.Heartbeat.capabilities)
...
inline void Heartbeat::set_capabilities(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:cordum.agent.v1.Heartbeat.capabilities)
}
...
inline void Heartbeat::set_capabilities(int index, const char* value) {
  ...
  _impl_.capabilities_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:cordum.agent.v1.Heartbeat.capabilities)
}
inline void Heartbeat::set_capabilities(int index, const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:cordum.agent.v1.Heartbeat.capabilities)
}
...
inline void Heartbeat::add_capabilities(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:cordum.agent.v1.Heartbeat.capabilities)
}
...
inline void Heartbeat::add_capabilities(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.capabilities_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:cordum.agent.v1.Heartbeat.capabilities)
}
inline void Heartbeat::add_capabilities(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:cordum.agent.v1.Heartbeat.capabilities)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Heartbeat::capabilities() const {
  // @@protoc_insertion_point(field_list:cordum.agent.v1.Heartbeat.capabilities)
  return _impl_.capabilities_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Heartbeat::mutable_capabilities() {
  // @@protoc_insertion_point(field_mutable_list:cordum.agent.v1.Heartbeat.capabilities)
  return &_impl_.capabilities_;
}
...
inline const std::string& Heartbeat::pool() const {
  // @@protoc_insertion_point(field_get:cordum.agent.v1.Heartbeat.pool)
...
void Heartbeat::set_pool(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.pool_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cordum.agent.v1.Heartbeat.pool)
}
inline std::string* Heartbeat::mutable_pool() {
  std::string* _s = _internal_mutable_pool();
  // @@protoc_insertion_point(field_mutable:cordum.agent.v1.Heartbeat.pool)
  return _s;
}
...
inline std::string* Heartbeat::release_pool() {
  // @@protoc_insertion_point(field_release:cordum.agent.v1.Heartbeat.pool)
...
inline int32_t Heartbeat::max_parallel_jobs() const {
  // @@protoc_insertion_point(field_get:cordum.agent.v1.Heartbeat.max_parallel_jobs)
...
Heartbeat::labels() const {
  // @@protoc_insertion_point(field_map:cordum.agent.v1.Heartbeat.labels)
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_cordum_2fagent_2fv1_2fheartbeat_2eproto
