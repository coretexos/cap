...
static ::_pb::Metadata file_level_metadata_coretex_2fagent_2fv1_2falert_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_coretex_2fagent_2fv1_2falert_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_coretex_2fagent_2fv1_2falert_2eproto = nullptr;

const uint32_t TableStruct_coretex_2fagent_2fv1_2falert_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::coretex::agent::v1::SystemAlert, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::coretex::agent::v1::SystemAlert, _impl_.level_),
  PROTOBUF_FIELD_OFFSET(::coretex::agent::v1::SystemAlert, _impl_.message_),
  PROTOBUF_FIELD_OFFSET(::coretex::agent::v1::SystemAlert, _impl_.component_),
  PROTOBUF_FIELD_OFFSET(::coretex::agent::v1::SystemAlert, _impl_.code_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::coretex::agent::v1::SystemAlert)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::coretex::agent::v1::_SystemAlert_default_instance_._instance,
};
...
const ::_pbi::DescriptorTable descriptor_table_coretex_2fagent_2fv1_2falert_2eproto = {
    ...
    file_level_metadata_coretex_2fagent_2fv1_2falert_2eproto, file_level_enum_descriptors_coretex_2fagent_2fv1_2falert_2eproto,
    file_level_service_descriptors_coretex_2fagent_2fv1_2falert_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_coretex_2fagent_2fv1_2falert_2eproto_getter() {
  return &descriptor_table_coretex_2fagent_2fv1_2falert_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_coretex_2fagent_2fv1_2falert_2eproto(&descriptor_table_coretex_2fagent_2fv1_2falert_2eproto);
namespace coretex {
namespace agent {
namespace v1 {
...
SystemAlert::SystemAlert(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:coretex.agent.v1.SystemAlert)
}
SystemAlert::SystemAlert(const SystemAlert& from)
  ...
  // @@protoc_insertion_point(copy_constructor:coretex.agent.v1.SystemAlert)
}
...
SystemAlert::~SystemAlert() {
  // @@protoc_insertion_point(destructor:coretex.agent.v1.SystemAlert)
...
// @@protoc_insertion_point(message_clear_start:coretex.agent.v1.SystemAlert)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "coretex.agent.v1.SystemAlert.level"));
        } else
          goto handle_unusual;
        continue;
      // string message = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "coretex.agent.v1.SystemAlert.message"));
        } else
          goto handle_unusual;
        continue;
      // string component = 3;
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "coretex.agent.v1.SystemAlert.component"));
        } else
          goto handle_unusual;
        continue;
      // string code = 4;
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "coretex.agent.v1.SystemAlert.code"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* SystemAlert::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:coretex.agent.v1.SystemAlert)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_level().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "coretex.agent.v1.SystemAlert.level");
  ...
  if (!this->_internal_message().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "coretex.agent.v1.SystemAlert.message");
    target = stream->WriteStringMaybeAliased(
  ...
  if (!this->_internal_component().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "coretex.agent.v1.SystemAlert.component");
    target = stream->WriteStringMaybeAliased(
  ...
  if (!this->_internal_code().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "coretex.agent.v1.SystemAlert.code");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:coretex.agent.v1.SystemAlert)
  return target;
}

size_t SystemAlert::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:coretex.agent.v1.SystemAlert)
  size_t total_size = 0;
...
void SystemAlert::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:coretex.agent.v1.SystemAlert)
...
// @@protoc_insertion_point(class_specific_copy_from_start:coretex.agent.v1.SystemAlert)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata SystemAlert::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_coretex_2fagent_2fv1_2falert_2eproto_getter, &descriptor_table_coretex_2fagent_2fv1_2falert_2eproto_once,
      file_level_metadata_coretex_2fagent_2fv1_2falert_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::coretex::agent::v1::SystemAlert*
Arena::CreateMaybeMessage< ::coretex::agent::v1::SystemAlert >(Arena* arena) {
  return Arena::CreateMessageInternal< ::coretex::agent::v1::SystemAlert >(arena);
}
