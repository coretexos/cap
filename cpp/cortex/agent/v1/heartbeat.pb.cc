...
static ::_pb::Metadata file_level_metadata_cortex_2fagent_2fv1_2fheartbeat_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_cortex_2fagent_2fv1_2fheartbeat_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_cortex_2fagent_2fv1_2fheartbeat_2eproto = nullptr;

const uint32_t TableStruct_cortex_2fagent_2fv1_2fheartbeat_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::cortex::agent::v1::Heartbeat, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::cortex::agent::v1::Heartbeat, _impl_.worker_id_),
  PROTOBUF_FIELD_OFFSET(::cortex::agent::v1::Heartbeat, _impl_.region_),
  PROTOBUF_FIELD_OFFSET(::cortex::agent::v1::Heartbeat, _impl_.type_),
  PROTOBUF_FIELD_OFFSET(::cortex::agent::v1::Heartbeat, _impl_.cpu_load_),
  PROTOBUF_FIELD_OFFSET(::cortex::agent::v1::Heartbeat, _impl_.gpu_utilization_),
  PROTOBUF_FIELD_OFFSET(::cortex::agent::v1::Heartbeat, _impl_.active_jobs_),
  PROTOBUF_FIELD_OFFSET(::cortex::agent::v1::Heartbeat, _impl_.capabilities_),
  PROTOBUF_FIELD_OFFSET(::cortex::agent::v1::Heartbeat, _impl_.pool_),
  PROTOBUF_FIELD_OFFSET(::cortex::agent::v1::Heartbeat, _impl_.max_parallel_jobs_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::cortex::agent::v1::Heartbeat)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::cortex::agent::v1::_Heartbeat_default_instance_._instance,
};

const char descriptor_table_protodef_cortex_2fagent_2fv1_2fheartbeat_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\037cortex/agent/v1/heartbeat.proto\022\017corte"
  "x.agent.v1\"\273\001\n\tHeartbeat\022\021\n\tworker_id\030\001 "
  ...
  "B\177\n\026ai.cortex.cap.agent.v1P\001Z+github.com"
  "/coretexos/cap/go/cortex/agent/v1\252\002\017Cort"
  "ex.Agent.V1\312\002\017Cortex\\Agent\\V1\352\002\021Cortex::"
  "Agent::V1b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_cortex_2fagent_2fv1_2fheartbeat_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_cortex_2fagent_2fv1_2fheartbeat_2eproto = {
    false, false, 377, descriptor_table_protodef_cortex_2fagent_2fv1_2fheartbeat_2eproto,
    "cortex/agent/v1/heartbeat.proto",
    &descriptor_table_cortex_2fagent_2fv1_2fheartbeat_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_cortex_2fagent_2fv1_2fheartbeat_2eproto::offsets,
    file_level_metadata_cortex_2fagent_2fv1_2fheartbeat_2eproto, file_level_enum_descriptors_cortex_2fagent_2fv1_2fheartbeat_2eproto,
    file_level_service_descriptors_cortex_2fagent_2fv1_2fheartbeat_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_cortex_2fagent_2fv1_2fheartbeat_2eproto_getter() {
  return &descriptor_table_cortex_2fagent_2fv1_2fheartbeat_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_cortex_2fagent_2fv1_2fheartbeat_2eproto(&descriptor_table_cortex_2fagent_2fv1_2fheartbeat_2eproto);
namespace cortex {
namespace agent {
namespace v1 {
...
Heartbeat::Heartbeat(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:cortex.agent.v1.Heartbeat)
}
Heartbeat::Heartbeat(const Heartbeat& from)
  ...
  // @@protoc_insertion_point(copy_constructor:cortex.agent.v1.Heartbeat)
}
...
Heartbeat::~Heartbeat() {
  // @@protoc_insertion_point(destructor:cortex.agent.v1.Heartbeat)
...
// @@protoc_insertion_point(message_clear_start:cortex.agent.v1.Heartbeat)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "cortex.agent.v1.Heartbeat.worker_id"));
        } else
          goto handle_unusual;
        continue;
      // string region = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "cortex.agent.v1.Heartbeat.region"));
        } else
          goto handle_unusual;
        continue;
      // string type = 3;
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "cortex.agent.v1.Heartbeat.type"));
        } else
          goto handle_unusual;
        continue;
      // float cpu_load = 4;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 58)) {
          ...
          do {
            ...
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "cortex.agent.v1.Heartbeat.capabilities"));
      ...
      case 11:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 90)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "cortex.agent.v1.Heartbeat.pool"));
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Heartbeat::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:cortex.agent.v1.Heartbeat)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_worker_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "cortex.agent.v1.Heartbeat.worker_id");
  ...
  if (!this->_internal_region().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "cortex.agent.v1.Heartbeat.region");
    target = stream->WriteStringMaybeAliased(
  ...
  if (!this->_internal_type().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "cortex.agent.v1.Heartbeat.type");
    target = stream->WriteStringMaybeAliased(
  ...
  for (int i = 0, n = this->_internal_capabilities_size(); i < n; i++) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "cortex.agent.v1.Heartbeat.capabilities");
  ...
  if (!this->_internal_pool().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "cortex.agent.v1.Heartbeat.pool");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:cortex.agent.v1.Heartbeat)
  return target;
}

size_t Heartbeat::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:cortex.agent.v1.Heartbeat)
  size_t total_size = 0;
...
void Heartbeat::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:cortex.agent.v1.Heartbeat)
...
// @@protoc_insertion_point(class_specific_copy_from_start:cortex.agent.v1.Heartbeat)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Heartbeat::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_cortex_2fagent_2fv1_2fheartbeat_2eproto_getter, &descriptor_table_cortex_2fagent_2fv1_2fheartbeat_2eproto_once,
      file_level_metadata_cortex_2fagent_2fv1_2fheartbeat_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::cortex::agent::v1::Heartbeat*
Arena::CreateMaybeMessage< ::cortex::agent::v1::Heartbeat >(Arena* arena) {
  return Arena::CreateMessageInternal< ::cortex::agent::v1::Heartbeat >(arena);
}
