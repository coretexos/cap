...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cortex_2fagent_2fv1_2fjob_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_cortex_2fagent_2fv1_2fjob_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_cortex_2fagent_2fv1_2fjob_2eproto
...
struct TableStruct_cortex_2fagent_2fv1_2fjob_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cortex_2fagent_2fv1_2fjob_2eproto;
namespace cortex {
namespace agent {
namespace v1 {
class JobRequest;
...
public:
  ...
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "cortex.agent.v1.JobRequest.EnvEntry.key");
 }
...
class JobRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cortex.agent.v1.JobRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "cortex.agent.v1.JobRequest";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:cortex.agent.v1.JobRequest)
 private:
  class _Internal;
...
class JobResult final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cortex.agent.v1.JobResult) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "cortex.agent.v1.JobResult";
  }
  protected:
  ...
  void clear_status();
  ::cortex::agent::v1::JobStatus status() const;
  void set_status(::cortex::agent::v1::JobStatus value);
  private:
  ::cortex::agent::v1::JobStatus _internal_status() const;
  void _internal_set_status(::cortex::agent::v1::JobStatus value);
  public:

  // @@protoc_insertion_point(class_scope:cortex.agent.v1.JobResult)
 private:
  class _Internal;
...
inline const std::string& JobRequest::job_id() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobRequest.job_id)
...
void JobRequest::set_job_id(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.job_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobRequest.job_id)
}
inline std::string* JobRequest::mutable_job_id() {
  std::string* _s = _internal_mutable_job_id();
  // @@protoc_insertion_point(field_mutable:cortex.agent.v1.JobRequest.job_id)
  return _s;
}
...
inline std::string* JobRequest::release_job_id() {
  // @@protoc_insertion_point(field_release:cortex.agent.v1.JobRequest.job_id)
...
inline void JobRequest::set_allocated_job_id(std::string* job_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cortex.agent.v1.JobRequest.job_id)
}
...
inline const std::string& JobRequest::topic() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobRequest.topic)
...
void JobRequest::set_topic(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.topic_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobRequest.topic)
}
inline std::string* JobRequest::mutable_topic() {
  std::string* _s = _internal_mutable_topic();
  // @@protoc_insertion_point(field_mutable:cortex.agent.v1.JobRequest.topic)
  return _s;
}
...
inline std::string* JobRequest::release_topic() {
  // @@protoc_insertion_point(field_release:cortex.agent.v1.JobRequest.topic)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cortex.agent.v1.JobRequest.topic)
}
...
inline ::cortex::agent::v1::JobPriority JobRequest::_internal_priority() const {
  return static_cast< ::cortex::agent::v1::JobPriority >(_impl_.priority_);
}
inline ::cortex::agent::v1::JobPriority JobRequest::priority() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobRequest.priority)
  return _internal_priority();
}
inline void JobRequest::_internal_set_priority(::cortex::agent::v1::JobPriority value) {
  
  _impl_.priority_ = value;
}
inline void JobRequest::set_priority(::cortex::agent::v1::JobPriority value) {
  _internal_set_priority(value);
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobRequest.priority)
}
...
inline const std::string& JobRequest::context_ptr() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobRequest.context_ptr)
...
void JobRequest::set_context_ptr(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.context_ptr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobRequest.context_ptr)
}
inline std::string* JobRequest::mutable_context_ptr() {
  std::string* _s = _internal_mutable_context_ptr();
  // @@protoc_insertion_point(field_mutable:cortex.agent.v1.JobRequest.context_ptr)
  return _s;
}
...
inline std::string* JobRequest::release_context_ptr() {
  // @@protoc_insertion_point(field_release:cortex.agent.v1.JobRequest.context_ptr)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cortex.agent.v1.JobRequest.context_ptr)
}
...
inline const std::string& JobRequest::adapter_id() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobRequest.adapter_id)
...
void JobRequest::set_adapter_id(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.adapter_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobRequest.adapter_id)
}
inline std::string* JobRequest::mutable_adapter_id() {
  std::string* _s = _internal_mutable_adapter_id();
  // @@protoc_insertion_point(field_mutable:cortex.agent.v1.JobRequest.adapter_id)
  return _s;
}
...
inline std::string* JobRequest::release_adapter_id() {
  // @@protoc_insertion_point(field_release:cortex.agent.v1.JobRequest.adapter_id)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cortex.agent.v1.JobRequest.adapter_id)
}
...
JobRequest::env() const {
  // @@protoc_insertion_point(field_map:cortex.agent.v1.JobRequest.env)
...
JobRequest::mutable_env() {
  // @@protoc_insertion_point(field_mutable_map:cortex.agent.v1.JobRequest.env)
...
inline const std::string& JobRequest::parent_job_id() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobRequest.parent_job_id)
...
void JobRequest::set_parent_job_id(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.parent_job_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobRequest.parent_job_id)
}
inline std::string* JobRequest::mutable_parent_job_id() {
  std::string* _s = _internal_mutable_parent_job_id();
  // @@protoc_insertion_point(field_mutable:cortex.agent.v1.JobRequest.parent_job_id)
  return _s;
}
...
inline std::string* JobRequest::release_parent_job_id() {
  // @@protoc_insertion_point(field_release:cortex.agent.v1.JobRequest.parent_job_id)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cortex.agent.v1.JobRequest.parent_job_id)
}
...
inline const std::string& JobRequest::workflow_id() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobRequest.workflow_id)
...
void JobRequest::set_workflow_id(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.workflow_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobRequest.workflow_id)
}
inline std::string* JobRequest::mutable_workflow_id() {
  std::string* _s = _internal_mutable_workflow_id();
  // @@protoc_insertion_point(field_mutable:cortex.agent.v1.JobRequest.workflow_id)
  return _s;
}
...
inline std::string* JobRequest::release_workflow_id() {
  // @@protoc_insertion_point(field_release:cortex.agent.v1.JobRequest.workflow_id)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cortex.agent.v1.JobRequest.workflow_id)
}
...
inline int32_t JobRequest::step_index() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobRequest.step_index)
...
inline const std::string& JobResult::job_id() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobResult.job_id)
  return _internal_job_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void JobResult::set_job_id(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.job_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobResult.job_id)
}
inline std::string* JobResult::mutable_job_id() {
  std::string* _s = _internal_mutable_job_id();
  // @@protoc_insertion_point(field_mutable:cortex.agent.v1.JobResult.job_id)
  return _s;
}
...
inline std::string* JobResult::release_job_id() {
  // @@protoc_insertion_point(field_release:cortex.agent.v1.JobResult.job_id)
  return _impl_.job_id_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cortex.agent.v1.JobResult.job_id)
}
...
inline ::cortex::agent::v1::JobStatus JobResult::_internal_status() const {
  return static_cast< ::cortex::agent::v1::JobStatus >(_impl_.status_);
}
inline ::cortex::agent::v1::JobStatus JobResult::status() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobResult.status)
  return _internal_status();
}
inline void JobResult::_internal_set_status(::cortex::agent::v1::JobStatus value) {
  
  _impl_.status_ = value;
}
inline void JobResult::set_status(::cortex::agent::v1::JobStatus value) {
  _internal_set_status(value);
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobResult.status)
}
...
inline const std::string& JobResult::result_ptr() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobResult.result_ptr)
...
void JobResult::set_result_ptr(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.result_ptr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobResult.result_ptr)
}
inline std::string* JobResult::mutable_result_ptr() {
  std::string* _s = _internal_mutable_result_ptr();
  // @@protoc_insertion_point(field_mutable:cortex.agent.v1.JobResult.result_ptr)
  return _s;
}
...
inline std::string* JobResult::release_result_ptr() {
  // @@protoc_insertion_point(field_release:cortex.agent.v1.JobResult.result_ptr)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cortex.agent.v1.JobResult.result_ptr)
}
...
inline const std::string& JobResult::worker_id() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobResult.worker_id)
...
void JobResult::set_worker_id(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.worker_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobResult.worker_id)
}
inline std::string* JobResult::mutable_worker_id() {
  std::string* _s = _internal_mutable_worker_id();
  // @@protoc_insertion_point(field_mutable:cortex.agent.v1.JobResult.worker_id)
  return _s;
}
...
inline std::string* JobResult::release_worker_id() {
  // @@protoc_insertion_point(field_release:cortex.agent.v1.JobResult.worker_id)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cortex.agent.v1.JobResult.worker_id)
}
...
inline int64_t JobResult::execution_ms() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobResult.execution_ms)
...
inline void JobResult::set_execution_ms(int64_t value) {
  ...
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobResult.execution_ms)
}
...
inline const std::string& JobResult::error_code() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobResult.error_code)
...
void JobResult::set_error_code(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.error_code_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobResult.error_code)
}
inline std::string* JobResult::mutable_error_code() {
  std::string* _s = _internal_mutable_error_code();
  // @@protoc_insertion_point(field_mutable:cortex.agent.v1.JobResult.error_code)
  return _s;
}
...
inline std::string* JobResult::release_error_code() {
  // @@protoc_insertion_point(field_release:cortex.agent.v1.JobResult.error_code)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cortex.agent.v1.JobResult.error_code)
}
...
inline const std::string& JobResult::error_message() const {
  // @@protoc_insertion_point(field_get:cortex.agent.v1.JobResult.error_message)
...
void JobResult::set_error_message(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.error_message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cortex.agent.v1.JobResult.error_message)
}
inline std::string* JobResult::mutable_error_message() {
  std::string* _s = _internal_mutable_error_message();
  // @@protoc_insertion_point(field_mutable:cortex.agent.v1.JobResult.error_message)
  return _s;
}
...
inline std::string* JobResult::release_error_message() {
  // @@protoc_insertion_point(field_release:cortex.agent.v1.JobResult.error_message)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cortex.agent.v1.JobResult.error_message)
}
...
template <> struct is_proto_enum< ::cortex::agent::v1::JobPriority> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::cortex::agent::v1::JobPriority>() {
  return ::cortex::agent::v1::JobPriority_descriptor();
}
template <> struct is_proto_enum< ::cortex::agent::v1::JobStatus> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::cortex::agent::v1::JobStatus>() {
  return ::cortex::agent::v1::JobStatus_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_cortex_2fagent_2fv1_2fjob_2eproto
